  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        <span className="mb-6 inline-flex items-center rounded-mk-pill border border-app-border bg-mk-bg-soft px-4 py-1.5 text-sm text-mk-fg-muted">
          {t('mk.hero.eyebrow')}
        </span>
        ...
        >
          {t('mk.hero.title.pre')}{' '}
          <span className="mk-gradient-text">{t('mk.hero.title.accent')}</span>{' '}
          {t('mk.hero.title.post')}
        </h1>

        <p className="mt-6 max-w-2xl text-lg text-mk-fg-muted sm:text-xl">
          {t('mk.hero.subtitle')}
        </p>
